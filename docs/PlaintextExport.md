...
```csv
SessionId,Timestamp,Exercise,Weight,WeightUnit,Reps,TargetReps,Notes,RPE
...
9c67f65a-3099-4d6b-b04d-428ce386f61d,2024-10-16T10:43:41,Squats,97.5,kg,8,8,,8.5
```

`RPE` is the rate of perceived exertion logged for the set (6-10, in half steps), and is blank when none was
